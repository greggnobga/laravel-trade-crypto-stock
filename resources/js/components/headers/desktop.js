...
const Desktop = (props) => {
    ...
    return (
        <header
            id="header"
            className={sticky ? "sticky fade-in-bottom" : "fade-in-top"}
        >
            <div className="explorer">
                <Link to="/stock-explorer">
                    <span
                        className={stockExplorerHover}
                        onMouseEnter={stockExplorerMouseEnter}
                        onMouseLeave={stockExplorerMouseLeave}
                    >
                ...
                <Link to="/crypto-explorer">
                    <span
                        className={cryptoExplorerHover}
                        onMouseEnter={cryptoExplorerMouseEnter}
                        onMouseLeave={cryptoExplorerMouseLeave}
                    >
            ...
            <div className="auth">
                {authenticated ? (
                    <Fragment>
                        ...
                        <Link to="/dashboard">
                            <span
                                className={dashboardHover}
                                onMouseEnter={dashboardMouseEnter}
                                onMouseLeave={dashboardMouseLeave}
                            >
