...
export const bluechipStockTrade = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
...
export const commonStockTrade = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const storeStockTrade =
    (token: string, symbol: string) => async (dispatch: ({ type, payload }: Action) => void) => {
        try {
            /** Dispatch action to set inital state. */
