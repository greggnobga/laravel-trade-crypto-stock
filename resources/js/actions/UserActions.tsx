...
export const resendEmail = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
...
export const resetPassword =
    (token: string, email: string, password: string) => async (dispatch: ({ type, payload }: Action) => void) => {
        try {
            /** Dispatch action to set inital state. */
...
export const forgotPassword = (email: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const verifyEmail = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const loginUser = (email: string, password: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const logoutUser = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Request data from backend. */
        const { data } = await axios({
            headers: {
...
export const tokenUser = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
