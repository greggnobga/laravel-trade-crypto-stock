...
export const buildWatchlist = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
...
export const storeWatchlist =
    (token: string, input: string) => async (dispatch: ({ type, payload }: Action) => void) => {
        try {
            /** Dispatch action to set inital state. */
...
export const fetchWatchlist = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
