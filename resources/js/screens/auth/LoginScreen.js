        ...
        <>
            ...
            {loading ? (
                ...
                <div className='form-center-margin my-2'>
                    <form method='post' onSubmit={submitHandler} className='form-group screen-size font-size gradient-huckle-berry'>
                        ...
                        <div className='form-control'>
                            ...
                            <input
                                ...
                                autoComplete='off'
                            />
                            {passwordHasError && <p className='form-alert'>Please enter a valid password.</p>}
                        </div>
