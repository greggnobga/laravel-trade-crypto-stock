                ...
                if (check === null || check === undefined) {
                    ...
                    if (record) {
                        record.addEventListener("click", (e) => {
                            if (e.target.dataset.action === "crypto") {
                                ...
                                let submit = document.querySelector(".crypto-moon-insert > .modal-form > .modal-group > .modal-button > .button-submit > .modal-insert");
                                if (submit) {
                                    let callback = () => {
                        ...
                        let close = document.querySelector(".crypto-moon-insert > .modal-form > .modal-group > .modal-close");
                        if (close) {
                            let callback = () => {
                        ...
                        let cancel = document.querySelector(".crypto-moon-insert > .modal-form > .modal-group > .modal-button > .button-dismiss > .modal-cancel");
                        if (cancel) {
                            let callback = () => {
                                this.backdrop({ action: "insert", mode: "hide" });
                            };
                        ...
                        if (update) {
                            for (let i = 0; i < update.length; i++) {
                                update[i].addEventListener("click", () => {
                                    ...
                                    /** set submit event listener. */
                                    let submit = document.querySelector(".crypto-moon-update > .modal-form > .modal-group > .modal-button > .button-submit > .modal-update");
                                    if (submit) {
                                        let callback = () => {
                            ...
                            /** set close event listener. */
                            let close = document.querySelector(".crypto-moon-update > .modal-form > .modal-group > .modal-close");
                            if (close) {
                                let callback = () => {
                            ...
                            /** set cancel event listener. */
                            let cancel = document.querySelector(".crypto-moon-update > .modal-form > .modal-group > .modal-button > .button-dismiss > .modal-cancel");
                            if (cancel) {
                                let callback = () => {
                                    this.backdrop({ action: "update", mode: "hide" });
                                };
                    ...
                    setTimeout(() => {
                        ...
                        if (destroy) {
                            ...
                            /** set close event listener. */
                            let close = document.querySelector(".crypto-moon-destroy > .modal-form > .modal-group > .modal-close");
                            if (close) {
                                let callback = () => {
                            ...
                            /** set cancel event listener. */
                            let cancel = document.querySelector(".crypto-moon-destroy > .modal-form > .modal-group > .modal-button > .button-dismiss > .modal-cancel");
                            if (cancel) {
                                let callback = () => {
                                    this.backdrop({ action: "destroy", mode: "hide" });
                                };
