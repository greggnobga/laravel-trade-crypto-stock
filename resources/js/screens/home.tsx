    ...
    return (
        <>
            <section className='w-full h-fit sm:h-64 md:h-96 grid auto-rows-min content-center hero-bg-image bg-cover bg-center bg-no-repeat mb-4'>
                <div className='p-4 pt-6 uppercase text-purple-800 bg-slate-100 bg-opacity-25 font-bold md:font-extrabold text-sm text-center sm:text-xl md:text-2xl'>
                ...
                <div className='p-4 text-blue-200 text-sm font-thin sm:font-light text-center sm:text-md md:text-xl'>
                    We help your money go further with no yearly fees and some of the most affordable prices in the
                    sector.
                </div>
            ...
            <section className='p-4 mb-4 grid auto-rows-min bg-slate-200 border border-slate-100 border-opacity-50 shadow'>
            ...
            <section className='p-4 mb-4 grid auto-rows-min bg-slate-200 border border-slate-100 border-opacity-50 shadow'>
                ...
                <div className='p-2 grid auto-rows-min gap-2 sm:grid-cols-2 md:grid-cols-3 border-three'>
                    ...
                    <div className='card flex flex-col scale-down'>
                        ...
                        <div className='p-2 flex-1'>
                            <h1 className='p-2 font-size bg-blue-300 text-purple-800'>
                                Losing Your Bitcoin In A Scenic Boating Accident
                            </h1>
                            <p className='font-size py-2'>
            ...
            <section className='p-4 grid auto-rows-min bg-slate-200 border border-slate-100 border-opacity-50 shadow'>
                <div className='p-2 mb-2 text-md text-center text-purple-800 bg-blue-300 uppercase'>
