...
export const startDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
...
export const priceDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const reportDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const dividendDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const sectorDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const listDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const companyDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const bluechipDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const edgeDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const edgeUpdateDashboard = (props) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const stockGainerDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
...
export const stockLosserDashboard = (token: string) => async (dispatch: ({ type, payload }: Action) => void) => {
    try {
        /** Dispatch action to set inital state. */
