...
Route::group(['middleware' => 'api'], function () {
    Route::get('/login', [App\Http\Controllers\Dashboard\DashboardController::class, 'login'])->name('login');
});

Route::group(['middleware' => 'auth:sanctum'], function () {
    Route::get('/test', [App\Http\Controllers\Dashboard\DashboardController::class, 'init']);
});
...
//     Route::post('/mailer', [App\Http\Controllers\Api\AuthController::class, 'mailer']);
// });

// Route::group(['middleware' => 'auth:sanctum'], function () {
//     Route::post('/resend', [App\Http\Controllers\Api\AuthController::class, 'resend']);
//     Route::post('/logout', [App\Http\Controllers\Api\AuthController::class, 'logout']);
//     Route::post('/verify/{token}', [App\Http\Controllers\Api\AuthController::class, 'verify']);
// });
