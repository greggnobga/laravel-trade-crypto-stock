...
const Register = () => {
  ...
  const userNameInputClasses = userNameHasError ? 'alert-border-warning' : '';
  const firstNameInputClasses = firstNameHasError ? 'alert-border-warning' : '';
  const lastNameInputClasses = lastNameHasError ? 'alert-border-warning' : '';
